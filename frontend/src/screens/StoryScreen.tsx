...
const StoryScreen = ({ character, theme, propImage, propDescription, propImageMimeType, onBack, onHome }: Props) => {
  ...
  const {
    connect, disconnect, togglePause, isPaused, sessionState, characterState,
  } = useConversation({
    character,
    theme,
    propImage,
  ...
  // Prime image generation context with the prop image (camera / sketch mode) as soon as
  // the session goes active. Not shown on canvas — used only as reference for the first scene.
  useEffect(() => {
